    ...
    <footer className={cx("wrapper-footer")}>
        <div className={cx("footer")}>
            <div className={cx("social-network")}>
                <a className={cx("icon-social")} target="blank" href="https://www.facebook.com/NetflixVietnam/?brand_redir=892716500824351">
                    <img src={icons.iconFB} alt="" />
                </a>
                <a className={cx("icon-social")} target="blank" href="https://www.instagram.com/netflixasia/">
                    <img src={icons.iconIG} alt="" />
                </a>
                <a className={cx("icon-social")} target="blank" href="https://twitter.com/NetflixAsia">
                    <img src={icons.iconTW} alt="" />
                </a>
                <a className={cx("icon-social")} target="blank" href="https://www.youtube.com/channel/UCZoC-XeDO7HxbAdeCaRPPCw/videos">
            ...
            <ul className={cx("member-footer")}>
                {members.map((member, index)=>(
                    <li className={cx("item-member-footer")} key={index}>
                        <a className={cx("link-")} href={member.href}>{member.title}</a>
                    </li>
                ))}
            </ul>
