    ...
    return (
        <div className={cx("wrapper-bill-board")}>
            <div className={cx("wrapper-banner")}>
                <img
                    className={cx("poster")}
                    src={posters.posterMuuCau}
                    alt=""
                />
                <div className={cx("info-poster")}>
                    <img
                        className={cx("title-logo")}
                        src={titles.titleMuuCau}
                        alt=""
                    />
                    <div className={cx("description")}>
                        Khi Chris và con trai bị đuổi ra khỏi nhà, cả hai đã
                        phải trải qua một giai đoạn khó khăn khi Chris chấp nhận
                        thử việc không lương tại một công ty môi giới chứng
                        khoán.
                    </div>
